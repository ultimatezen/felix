...
namespace easyunit
{
	...
	//	mainframe.m_editor.m_new_record = record_pointer(new record_local) ;
	//	mainframe.m_editor.m_old_record = record_pointer(new record_local) ;

	//	mainframe.m_editor.m_new_record->set_source(L"spam new") ;
	//	mainframe.m_editor.m_new_record->set_trans(L"egg new") ;
	//	mainframe.m_editor.m_old_record->set_source(L"spam old") ;
	//	mainframe.m_editor.m_old_record->set_trans(L"egg old") ;

	//	ASSERT_EQUALS_V(0, (int)mem->size()) ;
	//	mainframe.retrieve_record_results_state() ;
	//	ASSERT_EQUALS_V(1, (int)mem->size()) ;
	//}
	//TEST(TestCMainFrame, retrieve_record_results_state_added)
	//{
	//	MainFrameModel model ;
	//	CMainFrame mainframe(&model) ;
	//	memory_pointer mem = mainframe.get_memory_model()->get_first_memory() ;
	...
	//	mem->add_record(mainframe.m_editor.m_old_record) ;
	//	ASSERT_EQUALS_V(1, (int)mem->size()) ;
	//	mainframe.retrieve_record_results_state() ;
	//	ASSERT_EQUALS_V(1, (int)mem->size()) ;
	//}
