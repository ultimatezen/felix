...
namespace easyunit
{
	...
	TEST( view_state_gloss_lookup_test, handle_toggle_edit_mode_false )
	{
	...
	TEST( view_state_gloss_lookup_test, handle_toggle_edit_mode_true )
	{
		view_interface_fake view ;
	...
	TEST( view_state_gloss_lookup_test, show_content )
	{
		view_interface_fake view ;
		WindowListenerFake listener; 
		FelixModelInterfaceFake model ;
	...
	TEST( view_state_gloss_lookup_test, retrieve_edit_record_model )
	{
		view_interface_fake view ;
		WindowListenerFake listener; 
		FelixModelInterfaceFake model ;
	...
	TEST( view_state_gloss_lookup_test, retrieve_edit_record_listener )
	{
		view_interface_fake view ;
		WindowListenerFake listener; 
