...
namespace easyunit
{
	TEST( TestMultitermConversionDlg, instantiate)
	{
		CMultitermConversionDlg dialog ;
		ASSERT_EQUALS_V(IDD_MULTITERM_CONVERSION_DLG, CMultitermConversionDlg::IDD) ;
	}

	// CExportDialog message processing
	TEST( TestMultitermConversionDlg, test_message_WM_INITDIALOG)
	{
		CMultitermConversionDlg dialog ;
		LRESULT lResult = 1 ;
	...
	TEST( TestMultitermConversionDlg, test_message_IDOK)
	{
		CMultitermConversionDlg dialog ;
	...
	TEST( TestMultitermConversionDlg, test_message_IDCANCEL)
	{
		CMultitermConversionDlg dialog ;
		dialog.m_bModal = TRUE ;
		LRESULT lResult = 1 ;
	...
	TEST( TestMultitermConversionDlg, test_message_ZERO)
	{
		CMultitermConversionDlg dialog ;
		LRESULT lResult = 1 ;
