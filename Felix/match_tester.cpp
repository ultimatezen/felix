...
// Return type		: bool 
// Argument         : record_pointer rec
bool search_match_tester::test_validity( record_pointer rec )
{
...
// Return type		: bool 
// Argument         : record_pointer rec
bool search_match_tester::test_reliability( record_pointer rec )
{
...
// Return type		: bool 
// Argument         : record_pointer rec
bool search_match_tester_regex::test_validity( record_pointer rec )
{
	return rec->is_validated() ;
}
...
// Return type		: bool 
// Argument         : record_pointer rec
bool search_match_tester_regex::test_reliability( record_pointer rec )
{
	return ( m_params.m_min_reliability >= rec->get_reliability() ) ;
}
