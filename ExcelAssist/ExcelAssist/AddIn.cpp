...
*
 ...
 Right now, ExcelAssist only creates a menu. 

TODO:
 - Make interface more like PowerPoint Assist (e.g. control key for review functions)
 - Toolbar
 - Preferences dialog
 - Some easier way to translate multi-segment cells
