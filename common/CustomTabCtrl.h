/*!
   ...
   - Remove some some unnecessary ATLASSERT(this->IsWindow())
...
#endif
#pragma message( "   Tab control structures")
...
#pragma message( "    CTabViewTabItem")
...
public:
	...
	BOOL MoveItem(size_t nFromIndex, size_t nToIndex, bool bUpdateSelection = true, bool bNotify = true)
	{
		...
		if(!this->IsWindow() || nFromIndex >= m_Items.GetCount() || nToIndex >= m_Items.GetCount())
		{
			return FALSE;
		}
