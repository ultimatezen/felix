...
//	LRESULT NotifyHandler(int /*idCtrl*/, LPNMHDR /*pnmh*/, BOOL& /*bHandled*/)
	...
	static void FormatNum(CString& str,_variant_t vtNum,long nDec) {
		...
		nf.LeadingZero = _ttol(sDummy);
		GetLocaleInfo( loc, LOCALE_SGROUPING, sDummy, 16 );
		nf.Grouping = _ttol(sDummy);
...
public:
	...
	void SetItem(long nItem,LPCTSTR pszColumn,LPCTSTR Value) 
	{
		_variant_t vtVal( (Value) ) ;
		SetItem(nItem,pszColumn,vtVal);
	}
