...
class KeyMapperPpt : public KeyMapper
{
public:

	KeyTargetPpt	*m_target ;
	bool map_command(string command)
	{
		...
		if (boost::iequals(command, CMD_EXTEND_LOOKUP))
		{
